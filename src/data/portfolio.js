...
export const projects = [
  {
    ...
    tech: ['HTML/CSS/JS', 'Real-Time Data', 'Chart.js', 'Traffic AI', 'REST APIs'],
  ...
  },
  {
    ...
    description:
      'A collection of industry-recognized certifications that demonstrate proficiency across multiple domains — including full-stack web development, cloud platforms, databases, and algorithmic problem solving. These credentials validate hands-on skills and commitment to continuous learning.',
    features: [
      'Full-Stack Web Development (MERN) — Udemy',
      'Data Structures & Algorithms — Coursera',
      'SQL & Database Design — HackerRank',
      'React.js Developer Certification — Meta',
      'Cloud Computing Fundamentals — AWS Educate',
      'Python for Data Science — IBM / Cognitive Class',
    ],
    tech: ['MERN Stack', 'React', 'DSA', 'SQL', 'Python', 'Cloud', 'AWS'],
  ...
  },
  {
    ...
    tech: ['React', 'Node.js', 'Express', 'MySQL', 'JWT', 'Aiven Cloud', 'Tailwind CSS', 'pdf-lib'],
...
export const journeyPhases = [
  {
    ...
    highlights: ['IIIT Vadodara', 'B.Tech CSE', 'Batch of 2026', 'CGPA: Strong Academic Record'],
  ...
  },
  {
    ...
    subtitle: 'CodeChef 3⭐ · LeetCode 300+ Problems',
    description:
    ...
    highlights: ['CodeChef 3⭐', 'LeetCode 300+ solved', 'Codeforces rated', 'Contest participant'],
